...
/* coins.html.twig */
class __TwigTemplate_b735c3de92dba94ad0099290269fd196 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        if (is_iterable(($context["coins"] ?? null))) {
            // line 2
...
\t\t\t\t\t";
            ...
            $context['_seq'] = CoreExtension::ensureTraversable(($context["coins"] ?? null));
...
\t\t\t\t\t\t\t<td>";
                // line 23
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "coins", [], "any", false, false, false, 23), "html", null, true);
                yield "</td>
\t\t\t\t\t\t</tr>
\t\t\t\t\t";
            }
...
";
    ...
    {
        return new Source("", "coins.html.twig", "/www/wwwroot/wolfots.online/admin/pages/modules/templates/coins.html.twig");
    }
}
