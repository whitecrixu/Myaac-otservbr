...
/* balance.html.twig */
class __TwigTemplate_fde107da418970fe96cd0074a0dab98b extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 1
        if (is_iterable(($context["balance"] ?? null))) {
            // line 2
...
\t\t\t\t\t";
            ...
            $context['_seq'] = CoreExtension::ensureTraversable(($context["balance"] ?? null));
...
\t\t\t\t\t\t\t<td>";
                // line 23
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, $context["result"], "balance", [], "any", false, false, false, 23), "html", null, true);
                yield "</td>
\t\t\t\t\t\t</tr>
\t\t\t\t\t";
            }
...
";
    ...
    {
        return new Source("", "balance.html.twig", "/www/wwwroot/wolfots.online/admin/pages/modules/templates/balance.html.twig");
    }
}
